...
const BotName = 'Aram Bot'; 
const instagram = 'muhammadidrisaramdani- kaelMk_'; 
const aktif = 'Kapan bot aktif'; pada jam dan hari itu
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:Agus\n' // Nama kamu Aram
            + 'ORG:VVIPINDO;\n' // Nama bot Aram
            + 'TEL;type=CELL;type=VOICE;waid=6285524553034:+62 896-1346-9459\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
